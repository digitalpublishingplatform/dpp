...
namespace DigitalPublishingPlatform.Helpers
{
    public static class StringExtensions
    {
        ...
        public static MediaType GetMediaType(this string mime) {
            ...
            return mime.Contains("image") ? MediaType.Image : MediaType.Unknown;
        }

        public static string EncodeTo64(this string toEncode) {
            var asciiEncoding = new ASCIIEncoding();
            var toEncodeAsBytes = asciiEncoding.GetBytes(toEncode);
        ...
        public static string DecodeFrom64(this string encodedData)
        {
            ...
            return asciiEncoding.GetString(encodedDataAsBytes);            
        }

        public static string MustEndWith(this string s, string endWith)
        {
